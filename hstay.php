     ...
     ?>
        <form action="stay.php" method="post">
          <div class="form-group mx-auto" style="width: 50%; border: 1px solid black; display: flex; flex-direction: column; text-align: center; margin-top:1%; padding: 2%;">
            ...
            Reason  <input type="text" name="d2">
             <input type="hidden" name="n1" value="<?php echo $sname;?>">
             <input type="hidden" name="r1" value="<?php echo $roll1;?>">
            <input type="hidden" name="d3" value="abc">
            <br> <br>
